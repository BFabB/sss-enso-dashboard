...
::: {.cci-heritage}
<img src="assets/logos/CCI_SSS_Logo.png" alt="CCI+SSS Sea Surface Salinity logo" class="cci-logo">
<span>Built on the scientific and data heritage of ESA CCI+ Sea Surface Salinity (CCI+SSS).</span>
:::
...
<video class="dashboard-video" controls preload="none" poster="assets/figures/latest/dashboard_sss_enso_poster_latest.png?v={{< var asset_version >}}">
  <source src="assets/animations/dashboard_sss_enso_latest.mp4?v={{< var asset_version >}}" type="video/mp4">
...
![Fresh-pool boundary trajectories during the 2009–10, 2015–16 and 2023–24 El Niños and the ongoing 2026 event. The 2009–10 and 2026 trajectories are truncated where observations are unavailable or not yet available.](assets/animations/s34p8_el_nino_event_trajectories_latest.gif?v={{< var asset_version >}}){fig-alt="Longitude of the S34.8 fresh-pool boundary across four El Niño events, with a shared seasonal cycle progressing upward and partial records for 2009–10 and 2026."}
...
<video class="highlight-video" controls preload="none" poster="assets/figures/latest/combined_sss_enso_poster_latest.png?v={{< var asset_version >}}">
  <source src="assets/animations/combined_sss_enso_latest.mp4?v={{< var asset_version >}}" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
![Comparison between the SSS-based indicator and MEI.v2.](assets/figures/latest/sss_meiv2_s34-8_latest.png?v={{< var asset_version >}}){fig-alt="Comparison between the SSS-based ENSO indicator and MEI.v2."}

## Niño 3.4

Niño 3.4 is a classical SST-based ENSO index in the central-eastern equatorial Pacific.

![Comparison between the SSS-based indicator and Niño 3.4.](assets/figures/latest/sss_nino34_s34-8_latest.png?v={{< var asset_version >}}){fig-alt="Comparison between the SSS-based ENSO indicator and Niño 3.4."}
...
![Comparison between the SSS-based indicator and RONI.](assets/figures/latest/sss_roni_s34-8_latest.png?v={{< var asset_version >}}){fig-alt="Comparison between the SSS-based ENSO indicator and RONI."}
...
![Latest SSS-based ENSO indicator based on the displacement of the 34.8-pss isohaline.](assets/figures/latest/sss_index_latest.png?v={{< var asset_version >}}){fig-alt="Latest SSS-based ENSO indicator derived from the longitude of the 34.8 pss isohaline in the equatorial Pacific."}

## Full-period Hovmöller view

![Full-period Hovmöller diagram of equatorial sea surface salinity and the tracked 34.8-pss isohaline.](assets/figures/latest/sss_hovmoller_latest.png?v={{< var asset_version >}}){fig-alt="Hovmöller diagram showing equatorial sea surface salinity as a function of longitude and time with the tracked 34.8 pss isohaline."}
