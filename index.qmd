...
The curves below track the same 34.8-pss fresh-pool boundary (S34.8), aligned on a common event-relative seasonal cycle to compare the timing, speed and maximum observed eastward extent of its displacement. This comparison does not directly measure overall ENSO strength.

![Fresh-pool boundary trajectories during the 2009–10, 2015–16 and 2023–24 El Niños and the ongoing 2026 event. The 2009–10 and 2026 trajectories are truncated where observations are unavailable or not yet available.](assets/animations/s34p8_el_nino_event_trajectories_latest.gif){fig-alt="Longitude of the S34.8 fresh-pool boundary across four El Niño events, with a shared seasonal cycle progressing upward and partial records for 2009–10 and 2026."}
